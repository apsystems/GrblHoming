...
**
** Created: Tue Mar 20 13:24:13 2012
...
static const char qt_meta_stringdata_Options[] = {
    "Options\0\0coords\0toolCoord(float[])\0"
    "settings\0sendSettings(int)\0status\0"
    "enableToolsAddr(bool)\0"
};
...
void Options::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->toolCoord((*reinterpret_cast< float(*)[]>(_a[1]))); break;
        case 1: _t->sendSettings((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->enableToolsAddr((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Options::toolCoord(float _t1[])
{
...
// SIGNAL 1
void Options::sendSettings(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
